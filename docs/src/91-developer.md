...
3. Add this repo as a remote:
   ...
   ```bash
   git remote add upstream https://github.com/l-s-campos/BEM.jl
   ```
...
- Go back to main screen and click on the latest commit (link: <https://github.com/l-s-campos/BEM.jl/commit/main>)
...
- After that runs, the [stable docs](https://l-s-campos.github.io/BEM.jl/stable) should be updated. Check them and look for the version number.
